var json = [{
  ...
  capstonedesc: "Welcome to my capstone project! I created the Galvanize Student Gallery app you're using right now. The idea came about when I saw the opportunity to enhance the capstone showcase communications and guest experience by creating a portal for users to learn about Galvanize's newest developers, and to preview and browse projects before, during, and after the event. The app was created with React with React-Router, Node.js, Express, PostgreSQL, Knex, React-Bootstrap, and custom CSS, and utilizes Google Analytics to track statistics.",
  ...
  bio: "My name is Davia DeNisco, and I’m a software engineer based in New York City. Before pursuing web development, I worked in event management for The Estée Lauder Companies and for The Open Society Foundations. I'm currently looking for a full-time position as a software engineer. In the meantime, I'm working on several freelance projects and will soon be teaching an intro to JavaScript class. In my free time, I like to rescue cats, kiss wolves, hike across volcanoes, and do JavaScript algorithms.",
  ...
  bio: "My name is Don Tamayo. I started Web Developing through affiliate marketing, with curiosity on how to make money online, from then I started creating websites, monetizing, optimizing using different platforms to compete with other popular websites. My eagerness to grow my passion became stronger until I decided to formally train myself and enrolled in Galvanize which I learned unlimited load of knowledge. Outside of developer’s world, I am passionate in leading and serving my Church as a Seventh-day Adventist Pastor/Teacher in Philippines and in New Jersey SDA Conference. (2009 - 2017). I’m actively working as a freelance contractor in New Jersey, also I’m available to work full time position as a Full-Stack Engineer and join the workforce of Creative Mind in the World of technology.",
  funfact: "",
  funpic: "",
...
},
{
  ...
  personalsite: "http://contactstudentdirectly.surge.sh/",
  capstonelink: "https://drive.google.com/open?id=1jqcZa7v9d022uy7AlVe3nGawSWPahwjf",
  capstonedesc: "'Black Superheroes VR' is and app dedicated to black and Latino Superheroes. It serves as a Museum placed in the world of 'Wakanda' that showcases these  Superheroes and the Fist Comic appearance of the character.",
