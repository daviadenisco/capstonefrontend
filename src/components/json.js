var json = [{
  ...
  capstonedesc: "I created an app for Car Enthusiasts, it includes latest movies, news, blogs, sell  your cars and much more. I used reactJS, node modules NPMs ( npm react-router-dom react-fontawesome react-simple-sidenav react-slick axios json-server –dev) and firebase database, authenticaton, Heroku and many more.",
